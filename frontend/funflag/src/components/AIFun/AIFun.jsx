        ...
        <>
            {flags.work_in_progress.enabled ? (<Typography variant="h2" color="blue-gray" className="my-40">
                ...
                <div className="flex justify-center my-20">
                    <div className="relative w-[100vh] flex flex-col py-6 px-4 text-gray-700 bg-white shadow-md bg-clip-border rounded-xl" id='box-quiz-questions'>
                        {currentQuestionIndex === -1 && (
                            <div className="p-6 text-center" id='ai-fun-qa-section'>
